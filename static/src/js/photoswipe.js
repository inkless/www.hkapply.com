...
const $pswp = $(photoswipeHTML).appendTo('body');
const pswpElement = $pswp.get(0);
const $caseContainer = $('.case-container');
const photoItems = getAllPhotoItems();
// default options
...
function openPhotoswipe(event) {
  ...
  const gallery = new PhotoSwipe(pswpElement, PhotoSwipeUI_Default, photoItems, options);
  gallery.init();
}
